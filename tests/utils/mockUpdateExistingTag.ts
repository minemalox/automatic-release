...
const testInputNextReleaseTag = 'v0.0.1'
...
server.get(`/repos/marvinpinto/private-actions-tester/git/refs/tags/${testInputAutomaticReleaseTag}`, (req, res) => {
  res.json({
...
server.patch(`/repos/marvinpinto/private-actions-tester/git/refs/tags/${testInputAutomaticReleaseTag}`, (req, res) => {
  res.json({})
})
...
export const setupEnv = {
  ...
  INPUT_AUTOMATIC_RELEASE_TAG: testInputAutomaticReleaseTag.toString(),
  INPUT_RELEASE_VERSION: testInputNextReleaseTag,
  INPUT_LAST_RELEASE_TAG: testInputLastReleaseTag,
